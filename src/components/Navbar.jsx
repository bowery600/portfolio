  ...
  return (
    <motion.header
      ...
      className={[
        ...
        scrolled
          ? "bg-white/70 backdrop-blur-xl border-b border-black/[0.06] shadow-[0_1px_0_rgba(0,0,0,0.02),0_8px_24px_-12px_rgba(0,0,0,0.08)]"
    ...
    >
      ...
      >
        ...
        >
          <span className="relative inline-flex h-7 w-7 items-center justify-center rounded-md bg-[#1C1C1C] text-white">
        ...
        <ul className="hidden items-center gap-1 md:flex">
          {LINKS.map((l) => (
            <li key={l.href}>
              <a
                href={l.href}
                className="group relative rounded-md px-3 py-2 text-sm font-medium text-[#475569] transition-colors hover:text-[#1C1C1C] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#CFAE70] focus-visible:ring-offset-2 focus-visible:ring-offset-white"
              >
                {l.label}
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            type="button"
            onClick={() => setOpen((v) => !v)}
            className="inline-flex h-11 w-11 items-center justify-center rounded-md text-[#1C1C1C] hover:bg-black/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#CFAE70] md:hidden"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="overflow-hidden border-t border-black/[0.06] bg-white/85 backdrop-blur-xl md:hidden"
              ...
              {LINKS.map((l, i) => (
                <li key={l.href}>
                  <a
                    ...
                    className="block rounded-md px-3 py-3 text-base font-medium text-[#1C1C1C] hover:bg-black/[0.04] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#CFAE70]"
                  >
                    {l.label}
                  </a>
                </li>
